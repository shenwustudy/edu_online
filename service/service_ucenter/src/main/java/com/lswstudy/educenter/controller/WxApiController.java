...
import com.lswstudy.educenter.utils.ConstantWxUtils;
import com.lswstudy.educenter.utils.HttpClientUtils;
...
public class WxApiController {
    ...
    public String genQrConnect(HttpSession session) {
        ...
        String state = "lswstudy";//为了让大家能够使用我搭建的外网的微信回调跳转服务器，这里填写你在ngrok的前置域名
